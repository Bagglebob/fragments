...
// import DynamoDB AWS SDK for JS
const { DynamoDBClient } = require('@aws-sdk/client-dynamodb');

// Helper library to Convert a JavaScript object into a DynamoDB record (marshall)
...
/**
 * If AWS credentials are configured in the environment, use them (Not Needed for Deployment). 
 * NEEDED for testing locally
 * OR IF connecting to LocalStack or DynamoDB Local
